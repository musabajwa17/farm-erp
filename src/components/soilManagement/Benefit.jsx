...
export default function CallToAction() {
  ...
  style={{
    backgroundImage: "url('https://images.pexels.com/photos/1733192/pexels-photo-1733192.jpeg')",
  }}
>
  ...
  <div className="relative z-10 text-center max-w-3xl sm:max-w-4xl">
    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-6 leading-snug sm:leading-tight">
