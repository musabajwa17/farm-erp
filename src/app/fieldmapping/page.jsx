...
const FieldMappingPage = forwardRef(({ onAreaData, searchLocation }, ref) => {
...
function MapDetail({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Remove only map and form related keys, not all localStorage
      localStorage.removeItem("mapAreaInfo");
      localStorage.removeItem("areaUnit");
      localStorage.removeItem("mapCoordinates");
      localStorage.removeItem("shapeWidth");
      localStorage.removeItem("shapeHeight");
